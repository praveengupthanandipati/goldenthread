...
$address = "praveennandipati@gmail.com";
...
if (mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<strong>Success!</strong> Your message has been sent to our team. We will get back to you shortly.";
	echo "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>";
	echo "</div>";

} else {

	echo "<div class='alert alert-danger'>Error: We could not send your email. Please try again later.</div>";
